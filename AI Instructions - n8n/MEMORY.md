---
read: every session (first file, before any journal)
...
<!-- AGENT REMINDER: The n8n workflow pre-loads SOUL.md, AGENTS.md, and this file. Check current mode below. If the user is talking to you (coaching): also read STRATEGIES.md + JOURNAL_READING.md. -->
