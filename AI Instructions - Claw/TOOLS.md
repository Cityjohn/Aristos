...
Cron-based outreach replaces the native heartbeat. Full job definitions, prompts, and probability logic: see `CRON.md`.

Quick reference: 11 jobs total (3 coaching, 3 random, 3 review/weekly, 1 maintenance, 1 email). All isolated sessions, coordinated via `session-state.json`.
